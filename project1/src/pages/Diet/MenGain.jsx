  ...
  return (
    <>
      <div className='h-full w-full py-20'>
        <h1 className='text-3xl font-bold text-gray-200 flex items-center lg:justify-center md:justify-center sm:justify-center justify-center gap-x-5 mb-0 mt-2 bg-black/20 py-2 px-4 rounded-t-md '>  <IoIosPerson className='w-8 h-8  text-indigo-600' /> Weight Gain for Men </h1>
